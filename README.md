...
| grafana | object | `{"persistence":{"enabled":true}}` | The values for the Grafana subchart |
...
| identity.krbKeysOperator.image | object | `{"registry":"ghcr.io/amrc-factoryplus","repository":"acs-krb-keys-operator","tag":"latest"}` | The location and version of the Kerberos keys operator image |
...
| loki | object | `{"loki":{"auth_enabled":false,"commonConfig":{"replication_factor":1},"storage":{"type":"filesystem"}},"singleBinary":{"persistence":{"size":"10Gi"},"replicas":1}}` | The values for the Loki subchart |
...
| promtail | object | `{"loki":{"serviceName":"loki"}}` | The values for the Promtail subchart |
