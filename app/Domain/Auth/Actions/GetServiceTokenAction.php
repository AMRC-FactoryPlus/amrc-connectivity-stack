    ...
    )
    {
        ...
        if (!Cache::has(
            ...
            try {
                ...
                $clientContext->acquireCredentials(
                    $ccache2
                );
            ...
            $clientContext->initSecContext(
                ...
                0,
                null,
                $token // <- Can only use once
            );

            Log::debug(
                'Authorising against service',
                [
                    'service' => $service,
                    'token' => $token,
            ...
            Log::debug(
                'Service authorisation successful',
                [
                    'service' => $service,
