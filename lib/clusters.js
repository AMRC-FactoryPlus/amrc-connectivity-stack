...
export class Clusters {
    ...
    async create_cluster_objects (spec) {
        ...
        const namespace = util.format(spec.template.cluster.namespace, name);
    ...
    async create_flux_user (spec) {
        ...
        const name = util.format(flux.name, spec.name);
    ...
    async write_flux_source (co, repo) {
