...
class WsRequest implements ResolvableRequest<Duplex<Object, Object>>
{
    ...
    class Resolved implements PerformableRequest<Duplex<Object, Object>>
    {
        private URI uri;
        private URI base;
        ...
        public Single<Duplex<Object, Object>> perform (FPHttpClient client)
        {
            return client.textWebsocket(this.uri)
                .flatMap(this::handleRawWs);
        }

        private Single<Duplex<Object, Object>> handleRawWs (
            Duplex<String, String> raw)
        {
