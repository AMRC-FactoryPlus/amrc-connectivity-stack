...
This module has been compiled from TypeScript to ESM JAvascript and
bundled with ACS due to problems bunding the CommonJS version into
acs-admin.

This import was built from
https://github.com/APIDevTools/json-schema-ref-parser revision 69cfcf6b,
using `tsconfig` options `module: esnext` and `moduleResolution:
bundler`.
