...
export class ConfigDB extends Interfaces.ConfigDB {
    ...
    watch_config (app, obj) {
        return this.notify.watch(`v2/app/${app}/object/${obj}`);
    }
    ...
    /** Watch the subclasses of all members of a class.
     *
     * @returns A sequence of immutable Maps from UUID to Set.
     * @param klass A class UUID.
     */
    watch_members_subclasses(klass){
        return this.watch_members(klass)
            .pipe(this.expand_subclasses());
    }

    /** Watch the direct subclasses of all members of a class.
     *
     * @returns A sequence of immutable Maps from UUID to Set.
     * @param klass A class UUID.
     */
    watch_members_direct_subclasses(klass){
        return this.watch_members(klass)
            .pipe(this.expand_direct_subclasses());
    }
     ...
     */
    watch_list (app) {
        return this._watch_set(`v2/app/${app}/object/`);
    }
    ...
    search_app (app, filter) {
        return this.notify.search(`v2/app/${app}/object/`, filter);
    }
