...
export class ServiceError extends Error {
    constructor (service, message, status, body) {
        super(message);
    ...
    toString () {
        ...
        return [srv, this.message, this.status, body]
...
export class ServiceInterface {
     ...
     */
    throw (message, status, body) {
        throw new ServiceError(this.service, message, status, body);
    }
...
*/
    ...
    async load_dump (dump) {
        ...
        this.throw("Failed to load dump", st, body);
    }
