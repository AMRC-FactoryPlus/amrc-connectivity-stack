...
export class MQTTInterface extends ServiceInterface {
    ...
    /* As of @amrc-factoryplus/service-client, this always returns a new
     * connection. Sharing connections between App and Node is causing
     * problems. */
    ...
    /* This method is now async; this is an API change from
     * @amrc-factoryplus/utilities. The change is to make it possible to
